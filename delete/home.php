...
<body>
    <header>
        <nav class="navbar navbar-expand-lg navbar-white bg-white">
            <div class="container">
                <a class="navbar-brand wow slideInLeft" href="home.php"><img src="../img/paradise.png" alt="logo"
        ...
        <div id="carouselExampleCaptions" class=" carousel slide" data-ride="carousel">
            ...
            <div class="carousel-inner">
                <div class="carousel-item w3-animate-opacity active">
                    <img src="../img/resort1.jpg" class="d-block w-100" height="750px" alt="resort_img1">
                ...
                <div class="carousel-item w3-animate-opacity">
                    <img src="../img/resort2.jpg" class="d-block w-100" height="750px" alt="resort_img2">
                    <div class="carousel-caption caro-capt d-none d-md-block">
                ...
                <div class="carousel-item w3-animate-opacity">
                    <img src="../img/resort3.jpg" class="d-block w-100" height="750px" alt="resort_img3">
                    <div class="carousel-caption caro-capt d-none d-md-block">
                ...
                <div class="carousel-item w3-animate-opacity">
                    <img src="../img/resort4.jpg" class="d-block w-100" height="750px" alt="resort_img4">
                    <div class="carousel-caption caro-capt d-none d-md-block">
        ...
        <div class="tab-content" id="nav-tabContent">
            <div class="tab-pane fade show active" id="nav-single" role="tabpanel" aria-labelledby="nav-single-tab">
                <div class="container my-2 py-3">
                    <div class="row">
                        <div class="col-4">
                            <img src="../img/presidential_suite.jpg" width="100%">
                        </div>
                        <div class="col-8">
                            <h3>Lorem Ipsum</h3>
